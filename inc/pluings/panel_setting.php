...
$args = array(
	// This is where your data is stored in the database and also becomes your globSample Optionsal variable name.
	'opt_name'                  => $opt_name,
	...
	'menu_title'                => esc_html__( 'تنظیمات قالب', 'netelites' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'تنظیمات قالب', 'netelites' ),
...
$args['admin_bar_links'][] = array(
	'id'    => 'redux-docs',
	'href'  => '//devs.redux.io/',
	'title' => __( 'Documentation', 'netelites' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-support',
	'href'  => '//github.com/ReduxFramework/redux-framework/issues',
	'title' => __( 'Support', 'netelites' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-extensions',
	'href'  => 'redux.io/extensions',
	'title' => __( 'Extensions', 'netelites' ),
);
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
	...
	$args['intro_text'] = '<p>' . sprintf( esc_html__( 'Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: $%1$s', 'netelites' ), '<strong>' . $v . '</strong>' ) . '<p>';
} else {
	$args['intro_text'] = '<p>' . esc_html__( 'This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.', 'netelites' ) . '</p>';
}

// Add content after the form.
$args['footer_text'] = '<p>' . esc_html__( 'This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.', 'netelites' ) . '</p>';
...
$help_tabs = array(
	array(
		'id'      => 'redux-help-tab-1',
		'title'   => esc_html__( 'Theme Information 1', 'netelites' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'netelites' ) . '</p>',
	),
	array(
		'id'      => 'redux-help-tab-2',
		'title'   => esc_html__( 'Theme Information 2', 'netelites' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'netelites' ) . '</p>',
	),
);
...
$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'netelites' ) . '</p>';
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'تنظیمات عمومی', 'netelites' ),
		'id'               => 'general',
		...
		'fields' => array(
			array(
				'id' => 'logo',
				'type' => 'media',
				'title' => __( 'تصویر لوگو سایت' , 'netelites' ),
				'desc' => __( 'آپلود تصویر jpg,png' , 'netelites' ),
				'url' => false
			),
			array(
				'id' => 'favie_icon',
				'type' => 'media',
				'title' => __( 'تصویر فایو آیکون سایت' , 'netelites' ),
				'desc' => __( 'آپلود تصویر jpg,png' , 'netelites' ),
				'url' => false
			) 
		)
...
if ( ! function_exists( 'dynamic_section' ) ) {
	...
	function dynamic_section( array $sections ): array {
		$sections[] = array(
			'title'  => esc_html__( 'Section via hook', 'netelites' ),
			'desc'   => '<p class="description">' . esc_html__( 'This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', 'netelites' ) . '</p>',
...
if ( ! function_exists( 'change_defaults' ) ) {
	...
	function change_defaults( array $defaults ): array {
		$defaults['str_replace'] = esc_html__( 'Testing filter hook!', 'netelites' );
