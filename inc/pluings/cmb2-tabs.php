...
if( !class_exists( 'RGC_CMB2_Tabs' ) ) {
    ...
    class RGC_CMB2_Tabs {
        ...
        public function setup_admin_scripts() {
            ...
            wp_enqueue_style( 'cmb-tabs', get_theme_file_uri( 'assets/css/tabs.css'), array(), self::VERSION );
        ...
        public function setup_dark_mode() {
            wp_enqueue_style( 'cmb-tabs-dark-mode', get_theme_file_uri( 'assets/css/dark-mode.css'), array(), self::VERSION );
